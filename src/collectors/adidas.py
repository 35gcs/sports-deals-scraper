...
class AdidasCollector(BaseCollector):
    """Collector for Adidas deals."""
    
    def _parse_item_specific(self, item_html: str, deal_data: Dict[str, Any]) -> Dict[str, Any]:
        """Parse Adidas-specific data."""
        ...
        # Adidas brand is always Adidas
        deal_data['brand'] = 'Adidas'
        ...
        # Enhanced youth detection for Adidas
    ...
    def _map_category(self, category_text: str) -> str:
        """Map Adidas category text to our category enum."""
    ...
    def _map_sport(self, category_text: str) -> str:
        """Map Adidas category text to our sport enum."""
        category_text = category_text.lower()
