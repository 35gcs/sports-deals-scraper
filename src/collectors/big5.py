"""Big 5 Sporting Goods collector."""
...
class Big5Collector(BaseCollector):
    """Collector for Big 5 Sporting Goods deals."""
    
    def _parse_item_specific(self, item_html: str, deal_data: Dict[str, Any]) -> Dict[str, Any]:
        """Parse Big 5-specific data."""
        ...
        size_container = parser.css_first('.size-selector, .size-options, .size-list')
        if size_container:
        ...
        # Enhanced youth detection for Big 5
    ...
    def _map_category(self, category_text: str) -> str:
        """Map Big 5 category text to our category enum."""
    ...
    def _map_sport(self, category_text: str) -> str:
        """Map Big 5 category text to our sport enum."""
        category_text = category_text.lower()
    ...
    async def collect_deals(self) -> List[Deal]:
        """Collect deals from Big 5 Sporting Goods."""
