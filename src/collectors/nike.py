...
class NikeCollector(BaseCollector):
    """Collector for Nike deals."""
    
    def _parse_item_specific(self, item_html: str, deal_data: Dict[str, Any]) -> Dict[str, Any]:
        """Parse Nike-specific data."""
        ...
        # Nike brand is always Nike
        deal_data['brand'] = 'Nike'
        ...
        # Enhanced youth detection for Nike
    ...
    def _map_category(self, category_text: str) -> str:
        """Map Nike category text to our category enum."""
    ...
    def _map_sport(self, category_text: str) -> str:
        """Map Nike category text to our sport enum."""
        category_text = category_text.lower()
